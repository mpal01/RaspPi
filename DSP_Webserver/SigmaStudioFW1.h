...
#include "RaspPi_IC_1.h" //NOTE: This must be changed to match the name of your program!!
#include <stdint.h>
#include <fcntl.h>
#include <math.h>
#include <errno.h>
...
#include <string.h>
#include <stdlib.h>
#include "/home/pi/i2c/i2c_dev.h" //this is the LMSensors version of i2c-dev.h!!!
#include <fcntl.h>
...
double max = 8388608;
double fs = 48000; // fs=48kHz (used in converting frequency to and from 4 byte ADI_REG_TYPE)
